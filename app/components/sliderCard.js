...
function Slidercard({ data }) {
  ...
  return (
    <Link key={_id} href={`/product/${slug.current}`} className=" w-[280px]  rounded-t-xl overflow-hidden  shadow h-[210px]  md:h-[290px] transform transition duration-200 hover:scale-105 hover:rotate" >
      <img
